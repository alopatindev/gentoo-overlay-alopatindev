...
LICENSE="LGPL-2+"
SLOT="4"
IUSE="aqua broadway cloudproviders colord cups examples ffmpeg gstreamer +introspection reversed-list sysprof test vulkan wayland +X cpu_flags_x86_f16c"
REQUIRED_USE="
	|| ( aqua wayland X )
	test? ( introspection )
"
...
src_prepare() {
	...
	if use reversed-list ; then
		eapply "${FILESDIR}/gtk-reversed-list.patch"
	fi
}
